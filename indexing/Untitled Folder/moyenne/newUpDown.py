...
seuil_similarité = 0.2# 300

max_size = 54# la taile maximal de sac de profils # fixé selon la machine utilisé (sqrt(n))
...
################################################"#######################"
    ...
    def division_sac(pointeur, sac , label):
        ...
        if (pointeur.size  > max_size):  # cas N 2
            ...
            pointeur.pivotG = np.mean(sac1, 0)
            ...
            pointeur.pivotD= np.mean(sac2, 0)
